                    ...
                    {cartItems.length === 0 ? (
                        ...
                        <div className="cart-items">
                            {cartItems.map((item, index) => (
                                <div key={`${item._id}-${item.selectedSize}-${item.selectedColor}-${index}`} className="cart-item">
                                    <Link to={`/product/${item._id}`} onClick={() => setIsCartOpen(false)} className="cart-item-img">
                                        <img src={item.image} alt={item.name} />
                                    </Link>

                                    <div className="cart-item-info">
                                        <div className="cart-item-top">
                                            <Link to={`/product/${item._id}`} onClick={() => setIsCartOpen(false)} className="cart-item-name">
                                                <h4>{item.name}</h4>
                                            </Link>
                                            <button
